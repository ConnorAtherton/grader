...
! function($) {
    ...
    ParsleyUI.prototype = {
        ...
        manageError: function(constraint) {
            ...
            var constraintName = constraint.name,
                ...
                liError = {}, message = false !== this.options.errorMessage ? this.options.errorMessage : (constraint.name === 'type' ?
    ...
    $.fn.parsley = function(option, fn) {
        var namespace = {
            namespace: $(this).data('parsleyNamespace') ? $(this).data('parsleyNamespace') : ('undefined' !== typeof option && 'undefined' !== typeof option.namespace ? option.namespace : $.fn.parsley.defaults.namespace)
    ...
    $.fn.domApi = function(namespace) {
        var attribute,
            obj = {}, regex = new RegExp("^" + namespace, 'i');
